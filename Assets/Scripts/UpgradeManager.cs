...
public class UpgradeManager : Singleton<UpgradeManager>
{
    ...
    public void UpgradeScrapCap(string op, float mod)
    {
        if(op == "x ")
        {
    ...
    public void UpgradeScrapRecharge(string op, float mod)
    {
        if (op == "x ")
        {
    ...
    public void UpgradeConveyorSpeed(string op, float mod)
    {
        if (op == "x ")
        {
    ...
    public void UpgradeTruckCap(string op, float mod)
    {
        if (op == "x ")
        {
    ...
    public void UpgradeTruckSpeed(string op, float mod)
    {
        if (op == "x ")
        {
    ...
    public void UpgradeFabricatorSpeed(string op, float mod)
    {
        if (op == "x ")
        {
    ...
    public void UpgradeRobotValue(string op, float mod)
    {
        if (op == "x ")
        {
